...
OPERATOR_BLS_KEY_PASSWORD=7YNvInegxN5GRFPUh4Ju OPERATOR_ECDSA_KEY_PASSWORD=7F6rZFySHCcyzou3e4W2 operator --config tests/nodes/operators/1/config-devnet.yaml